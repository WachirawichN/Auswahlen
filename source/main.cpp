...
int main()
{
    ...
    // Create object, shader, variable, blah blah blah here
    {
        ...
        std::shared_ptr<object::cube> physBlock1(new object::cube(true, false, 0.5f, glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 1.0f, 1.0f)));
        currentSimulation.addObject(physBlock1);
        std::shared_ptr<object::cube> physBlock2(new object::cube(true, false, 1.0f, glm::vec3(-7.5f, 7.5f, 0.0f), glm::vec3(2.5f, -2.5f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.5f, 0.5f, 0.5f)));

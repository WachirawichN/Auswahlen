...
int main()
{
    ...
    // Create object, shader, variable, blah blah blah here
    {
        ...
        std::shared_ptr<object::cube> physBlock0(new object::cube(true, false, 1.0f, glm::vec3(1.0f, 0.5f, 0.0f), glm::vec3(-2.5f, -1.5f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 1.0f, 1.0f)));
        currentSimulation.addObject(physBlock0);
        std::shared_ptr<object::cube> physBlock1(new object::cube(true, false, 1.0f, glm::vec3(-1.0f, 0.0f, 0.0f), glm::vec3(2.5f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(10.0f, 5.0f, 1.5f)));
